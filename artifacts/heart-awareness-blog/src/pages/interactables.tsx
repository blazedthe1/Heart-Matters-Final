    ...
    <div className="min-h-screen font-['Outfit',sans-serif]" style={{ background: "#0f0c0c" }}>
      ...
      <div className="py-12 px-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Heart Defender — featured tall card */}
          <motion.div
          ...
          >
            <button
              ...
              className="group w-full h-full min-h-[260px] rounded-2xl p-7 flex flex-col justify-between cursor-pointer transition-all text-left"
            ...
            >
              <div>
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-5"
                  style={{ background: "rgba(185,28,28,0.2)", border: "1px solid rgba(185,28,28,0.35)" }}>
                  <span className="text-3xl">❤️</span>
                </div>
                <p className="text-[10px] uppercase tracking-widest text-red-400 font-medium mb-2">Game</p>
                <h2 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {t("int_game_name")}
                </h2>
                <p className="text-sm text-white/40 leading-relaxed">{t("int_game_desc")}</p>
              </div>
              <div className="mt-6 flex items-center gap-2">
                <span className="px-5 py-2.5 rounded-xl bg-red-700 group-hover:bg-red-600 transition-colors text-white text-sm font-semibold">
                  ▶ {t("int_game_play")}
                </span>
                <span className="text-xs text-white/20">Combos · Power-ups</span>
              </div>
            </button>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="px-3 py-1.5 rounded-lg text-xs font-semibold text-indigo-300 group-hover:bg-indigo-800/60 transition-colors"
                  style={{ background: "rgba(79,70,229,0.2)" }}>
                  {t("int_explorer_cta")} →
                </span>
              </div>
              <div className="mt-4">
                <p className="text-[10px] uppercase tracking-widest text-indigo-400 font-medium mb-1">3D Anatomy</p>
                <h3 className="text-lg font-bold text-white" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {t("int_explorer_name")}
                </h3>
                <p className="text-xs text-white/35 mt-1">{t("int_explorer_desc")}</p>
              </div>
            </button>
          </motion.div>
          ...
          {/* Myth vs Fact — full width bottom row */}
          <motion.div
          ...
          >
            <div className="rounded-2xl overflow-hidden"
              ...
              <div className="px-6 pt-6 pb-2 flex items-start justify-between">
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-violet-400 font-medium mb-1">Quiz</p>
                  <h3 className="text-lg font-bold text-white" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                    {t("int_myth_title")}
                  </h3>
                  <p className="text-xs text-white/35 mt-0.5">{t("int_myth_desc")}</p>
                </div>
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ml-3"
